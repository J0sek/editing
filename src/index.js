...
newItemSubmit.addEventListener("click", () => {
  ...
  newItemPriority = newItemPriority.classList[0].substring(9);
...
newProject.addEventListener("submit", () => {
  ...
  let newProjectName = document.querySelector(".new-project-input-name");

  newProjectName = newProjectName.value;

  addProjectDOM(newProjectName);

  newProject.reset();
});

const cancel = document.querySelector(".new-project-input-cancel");
